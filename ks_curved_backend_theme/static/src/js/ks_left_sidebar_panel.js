...
//    var { MenusService } = require("@web/webclient/menus/menu_service");
    ...
    patch(NavBar.prototype, "ks_left_sidebar_panel", {
      async setup(parent, menuData) {
        this._super();
        this.parent = parent;
        this._apps = menuData;
        this.rpc = useService("rpc");
        useListener("click", "#ks_app_drawer_toggle", this._ksAppsDrawerClick);
        ...
        useListener( "click", "div.overlay", this._ksCloseMobileDrawer);
