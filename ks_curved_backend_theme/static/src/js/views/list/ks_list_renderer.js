odoo.define("ks_curved_backend_theme.ks_list_renderer", function (require) {
  ...
  var KsListDocumentViewer = require("ks_curved_backend_theme.KsListDocumentViewer");
  ...
  var Ks_ListRenderer = ListRenderer.include({
        ...
        return form_view_controller.then(function (formView) {
              ...
              return self.split_view_data.split_form_view.appendTo(fragment)
                  .then(function () {
                        ...
                        self.split_view_data.split_form_view.toolbarActions = {}
    ...
    _create_separator_for_split_window: function(fragment, split_mode){
        ...
        self.split_view_data.$split_separator.on("dragstop", function(event, ui) {
          ...
          self._rpc({
            route: "/ks_curved_backend_theme/save/ks_splitted_form_width",
            params: {
              'data': val
            }
          });
