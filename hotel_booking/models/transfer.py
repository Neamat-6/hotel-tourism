...
class HotelTransfer(models.Model):
    ...
    booking_line_id = fields.Many2one('hotel.booking.line', string="Booking #", required=True)
    booking_id = fields.Many2one('hotel.booking', string="Booking #", readonly=True, related="booking_line_id.booking_id")
