...
class CheckBookingLineReportXlsx(models.AbstractModel):
    _name = 'report.hotel_booking.check_booking_line_xlsx_report'
    ...
    def generate_xlsx_report(self, workbook, data, objs):
        ...
        sheet = workbook.add_worksheet('Booking Check In/Out Report')
        wizard = objs[0]
