...
class Booking2Quotation(models.TransientModel):
    _name = 'crm.booking.partner'
    _description = 'Create new or use existing Customer on new booking'

    @api.model
    def default_get(self, fields):
        result = super(Booking2Quotation, self).default_get(fields)
