...
class Partner(models.Model):
    ...
    actual_main_makkah = fields.Many2one('actual.hotel', "Actual Makkah Hotel", related='package_id.actual_main_makkah', store=True)
    actual_main_madinah = fields.Many2one('actual.hotel', "Actual Madinah Hotel", related='package_id.actual_main_madinah', store=True)
    actual_main_hotel = fields.Many2one('actual.hotel', "Actual Hotel", related='package_id.actual_main_hotel', store=True)
