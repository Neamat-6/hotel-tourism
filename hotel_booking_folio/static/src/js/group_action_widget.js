odoo.define('hotel_booking_folio.group_action_widgets', function (require) {
	"use strict";
    ...
    var One2manyGroupAction = FieldOne2Many.extend({
        limit: 100000,
		template: 'One2manyGroupAction',
		events: {
			"click #button_amend_order_lines": "amend_selected_lines",
			"click .button_select_order_lines": "selected_lines",
		},
		init: function() {
	        this._super.apply(this, arguments);
	    },
		amend_selected_lines: function(){
			var self=this;
			...
			var w_response = confirm("Dou You Want to Amend ?");
			if (w_response) {
                    self.do_action({
                        ...
                        target: 'new',
                        context: {
                            'default_folio_ids': selected_lines
                        },
                    });
             }
		},
	...
	fieldRegistry.add('one2many_group_action', One2manyGroupAction);
});