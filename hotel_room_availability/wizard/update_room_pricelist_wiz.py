...
class UpdateRoomPricelist(models.TransientModel):
    ...
    def update_room_price(self):
        ...
        pricelist_line_obj = self.env['room.availability.line']
        for rec in self:
            period_list = []
            ...
            for line in rec.room_pricelist_line_ids:
                for i in date_list:
                    ...
                    if line_rec:
                        line_rec.write({'room_cost_price': line.price})
            #         else:
            #             vals = {
            ...
            # rec.room_availability_id.room_pricelist_ids = period_list
...
class UpdateRoomPricelistLine(models.TransientModel):
    ...
    hotel_id = fields.Many2one('hotel.hotel', string='Hotel', related='room_pricelist_id.hotel_id', store=True)
