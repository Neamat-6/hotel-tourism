odoo.define('os_theme_butterfly.BaseSettingMobile', function (require) {
    "use strict";
    ...
    BaseSetting.Renderer.include(Object.assign({}, KanbanRendererUtilities, {
        start: function () {
        ...
        on_attach_callback: function () {
            ...
            this._getTabPosition(this.modules, this.currentIndex, this.$('.settings_tab'));
        },
        ...
        _activateSettingMobileTab: function (currentTab) {
            ...
            this._getTabPosition(this.modules, moveTo, this.$('.settings_tab'));
        },
